...
! function(y) {
	...
	var p, h, b, x, T, E = function(e) {
		...
		O = (x = {
			...
			toString: v("none()")
		}, Object.freeze && Object.freeze(x), x),
		A = function(n) {
			var e = function() {
					return n
				},
		...
		j = P("function"),
		U = P("number"),
		B = void 0 === (T = Array.prototype.indexOf) ? function(e, t) {
			return z(e, t)
		} : function(e, t) {
			return T.call(e, t)
		},
	...
	var he = {
			...
			clone: function(e) {
				var t;
				return ge(t = pe(e.width, e.height))
					.drawImage(e, 0, 0), t
			},
			resize: ve,
			get2dContext: ge,
	...
	function De(r) {
		return new be(function(e, n) {
			...
			t.open("GET", r, !0), t.responseType = "blob", t.onload = function() {
				...
				var e, t = this;
				n(0 === this.status ? ((e = new Error("No access to download image"))
					.code = 18, e.name = "SecurityError", e) : new Error("Error " + t.status + " downloading image"))
			}, t.send()
		})
	}
	...
	var Pe = {
			...
			canvasToBlob: function(e, n, r) {
				return n = n || "image/png", y.HTMLCanvasElement.prototype.toBlob ? new be(function(t) {
					e.toBlob(function(e) {
						t(e)
					}, n, r)
				}) : Ae(e.toDataURL(n, r))
			...
			canvasToDataURL: function(e, t, n) {
				return t = t || "image/png", e.then(function(e) {
			...
			blobToCanvas: function(e) {
				return Ne(e)
					.then(function(e) {
						var t, n;
						return t = e, y.URL.revokeObjectURL(t.src), n = he.create(ye.getWidth(e), ye.getHeight(e)), he.get2dContext(n)
							.drawImage(e, 0, 0), n
					})
			},
	...
	var Ue, Be, Ye = {
		...
		Tt = function(n) {
			return (e = n, "" === e ? _.none() : _.some(e.substr(0, 1)))
				.bind(function(t) {
					return (e = n, "" === e ? _.none() : _.some(e.substring(1)))
						.map(function(e) {
		...
		Ot = function(e) {
			var t, n, r, o, i, a, u, c, s, l, f, d = Dt.browsers(),
				m = Dt.oses(),
				p = gt(d, e)
				.fold(at.unknown, at.nu),
				g = vt(m, e)
				.fold(mt.unknown, mt.nu);
			return {
				browser: p,
				os: g,
				deviceType: (n = p, r = e, o = (t = g)
					.isiOS() && !0 === /ipad/i.test(r), i = t.isiOS() && !o, a = t.isAndroid() && 3 === t.version.major, u = t.isAndroid() && 4 === t.version.major, c = o || a || u && !0 === /mobile/i.test(r), s = t.isiOS() || t.isAndroid(), l = s && !c, f = n.isSafari() && t.isiOS() && !1 === /safari/i.test(r), {
						isiPad: v(o),
						isiPhone: v(i),
						isTablet: v(c),
						isPhone: v(l),
		...
		jt = y.Node.TEXT_NODE,
		Ut = (y.Node.PROCESSING_INSTRUCTION_NODE, y.Node.ENTITY_REFERENCE_NODE, y.Node.ENTITY_NODE, y.Node.NOTATION_NODE, function(e) {
			return e.dom()
		...
		cn = {
			...
			fromPoint: function(e, t, n) {
				var r = e.dom();
				return _.from(r.elementFromPoint(t, n))
					.map(un)
			}
		},
		sn = {
		...
		Tn = function(o) {
			...
			t = function() {
				return i = {}, a = 0, dn.each(o.attributes, function(e) {
					var t, n = e.nodeName,
						r = e.value;
					(!1 !== (t = e)
						.specified || "name" === t.nodeName && "" !== t.value) && null != r && (i[n] = r, a++)
		...
		In = function(i, e, t) {
			...
			switch (i.nodeType) {
				case 1:
					e ? n = yn : (n = hn, a = Tn(i), u = {}, c = i, s = function(e, t) {
							u[e] = t
						}, null != (d = t || c.getAttribute("style")) && d.split || (d = c.style.cssText), dn.each(d.split(";"), function(e) {
							var t = e.indexOf(":");
							0 < t && ((l = dn.trim(e.substring(0, t)))
								.toUpperCase() === l && (l = l.toLowerCase()), l = l.replace(/([A-Z])/g, function(e, t) {
									return "-" + t.toLowerCase()
								}), f = dn.trim(e.substring(t + 1)), wn || (wn = 0 === l.indexOf("mso-")), s(l, f))
						}), wn || (f = c.style["mso-list"]) && s("mso-list", f)), r = "HTML" !== i.scopeName && i.scopeName && i.tagName && i.tagName.indexOf(":") <= 0 ? (i.scopeName + ":" + i.tagName)
						.toUpperCase() : i.tagName;
					break;
				case 3:
					n = bn, o = i.nodeValue;
					break;
		...
		Dn = function(e, o) {
			...
			return {
				...
				next: function() {
					var e, t, n = a,
						r = c;
					return !c && a.firstChild ? (u.push(a), a = a.firstChild) : c || 1 !== a.nodeType ? a.nextSibling ? (a = a.nextSibling, c = !1) : (a = u.pop(), c = !0) : c = !0, n === Cn.FINISHED || a || (o.body.removeChild(i), a = Cn.FINISHED), t = r, (e = n) === Cn.FINISHED ? e : e ? Cn.token(e, t) : void 0
				}
			}
		},
		On = function(p, g) {
		...
		jn = [Fn],
		Un = tinymce.isIE && 9 <= document.documentMode ? [function(e) {
		...
		Yn = /^(mso-.*|tab-stops|tab-interval|language|text-underline|text-effect|text-line-through|font-color|horiz-align|list-image-[0-9]+|separator-image|table-border-color-(dark|light)|vert-align|vnd\..*)$/,
		Hn = An(function(e, t) {
		...
		Vn = function() {
			...
			return "Ignore" === Cn.token(e.firstChild)
				.getStyle("mso-list")
		}(),
		Xn = function(e, t) {
		...
		tr = function(e, t) {
			...
			else if (t.type() === Cn.END_ELEMENT_TYPE && (Jn.pop(), 0 === Jn.length)) return void
			function(e) {
				if (Qn) {
					var t = void 0,
						n = Zn.length,
		...
		nr = An(function(e, t) {
			...
			0 === (Zn = Zn || [])
				.length ? t.type() === Cn.START_ELEMENT_TYPE ? n(t) ? e.emit(t) : tr(e, t) : e.emit(t) : (Qn || (Qn = n(t)), tr(e, t))
		}),
		rr = _n(function(e, t) {
		...
		sr = An(function(e, t) {
			var n;
			t.type() === Cn.START_ELEMENT_TYPE && "A" === t.tag() ? (cr.push(t), ur(t) && e.defer(t)) : t.type() === Cn.END_ELEMENT_TYPE && "A" === t.tag() ? (n = cr.pop(), ur(n) && e.defer(t), 0 === cr.length && e.emitDeferred()) : e.hasDeferred() ? e.defer(t) : e.emit(t)
		}),
		lr = !1,
		fr = [An(function(e, t) {
		...
		Er = {
			guessListType: function(e, t, n) {
				var r, o, i, a = null;
				return e && (r = e.text, o = e.symbolFont), r = dn.trim(r), (a = br[r]) ? a = xr(a, r) : o ? a = (a = yr[r]) ? xr(a, r) : {
					tag: "UL",
					variant: r
				} : (dn.each(hr, function(e) {
					if (e.regex.test(r)) {
						if (t && Tr(e.type, t, !0)) return (a = e.type)
							.start = parseInt(r, 10), !1;
						a || (a = e.type), a.start = parseInt(r, 10)
					}
				}), a && !a.variant && (i = "(" === r.charAt(0) ? "()" : ")" === r.charAt(r.length - 1) ? ")" : ".", a = xr(a, i))), a && "OL" === a.tag && n && ("P" !== n.tag() || /^MsoHeading/.test(n.getAttribute("class"))) && (a = null), a
			},
			eqListType: Tr,
		...
		Lr = function() {
			...
			return {
				guessIndentLevel: function(e, t, n, r) {
					var o, i;
					return r && /^([0-9]+\.)+[0-9]+\.?$/.test(r.text) ? r.text.replace(/([0-9]+|\.$)/g, "")
						.length + 1 : (o = u || parseInt(Ir(n, t.getAttribute("class"))), i = function(e, t) {
							var n, r = 0;
		...
		Cr = function() {
			...
			return {
				check: function(e) {
					return t && e.type() === Cn.TEXT_TYPE ? (e.text(), !0) : e.type() === Cn.START_ELEMENT_TYPE && "STYLE" === e.tag() ? t = !0 : e.type() === Cn.END_ELEMENT_TYPE && "STYLE" === e.tag() && !(t = !1)
				}
			}
		},
		...
		var i, o = [],
			...
			l = function(e, t) {
				...
				s++, t && e.type && (n = {
					...
					start: e.start
				}), o.push(e), a.emit(Cn.createStartElement(e.tag, r, n, u)), i = e
			},
			f = function() {
				a.emit(Cn.createEndElement(o.pop()
					.tag, u)), s--, i = o[o.length - 1]
			},
			d = function() {
				var e = c ? c.pop() : "P";
			...
			m = function(e, t, n) {
				...
				i && !Er.eqListType(i, t) && (f(), n && (a.emit(Cn.createStartElement("P", {}, {}, u)), a.emit(Cn.createText("\xa0", u)), a.emit(Cn.createEndElement("P", u))), l(t, !0)), a.emit(Cn.createStartElement("LI", {}, r, u)), e && "P" !== e.tag() ? (c.push(e.tag()), e.filterStyles(function() {
					return null
				}), a.emit(e)) : c.push("P")
			};
		return {
	...
	var Or = function(e, t) {
		...
		Rr = function(e, t, n) {
			n.type() === Cn.TEXT_TYPE ? n.isWhitespace() || (t.nextFilter = Fr, t.bulletInfo = {
				text: n.text(),
				symbolFont: t.symbolFont
			}) : zn(n) ? n.type() === Cn.START_ELEMENT_TYPE ? t.spanCount.push(n) : t.spanCount.pop() : n.type() === Cn.START_ELEMENT_TYPE && "IMG" === n.tag() ? (t.nextFilter = Fr, t.bulletInfo = {
				text: "\u2202",
				symbolFont: !0
			}) : Or(e, n)
		},
		Fr = function(e, t, n) {
			n.type() === Cn.START_ELEMENT_TYPE && zn(n) ? (t.spanCount.push(n), t.nextFilter = jr) : n.type() === Cn.END_ELEMENT_TYPE && zn(n) ? (t.spanCount.pop(), t.nextFilter = Ur) : n.type() === Cn.END_ELEMENT_TYPE && "IMG" === n.tag() || Or(e, n)
		},
		jr = function(e, t, n) {
		...
		Ur = function(o, i, a) {
			var e = function(e) {
				var t, n, r;
				if (i.nextFilter = Br, i.commentMode && (i.itemLevel = i.indentGuesser.guessIndentLevel(a, i.originalToken, i.styles.styles, i.bulletInfo)), i.listType = Er.guessListType(i.bulletInfo, (t = i.emitter.getCurrentListType(), n = i.emitter.getCurrentLevel(), r = i.itemLevel, n === r ? t : null), i.originalToken), i.listType) {
		...
		Hr = {},
		Wr = function(e) {
			Hr.nextFilter = Yr.initial, Hr.itemLevel = 0, Hr.originalToken = null, Hr.commentMode = !1, Hr.openedTag = null, Hr.symbolFont = !1, Hr.listType = null, Hr.indentGuesser = Lr(), Hr.emitter = Dr(e, e.document), Hr.styles = Cr(), Hr.spanCount = [], Hr.skippedPara = !1, Hr.styleLevelAdjust = 0, Hr.bulletInfo = void 0
		};
	Wr({});
	...
	function Zr(a, u, c) {
		return {
			showDialog: function(o) {
				var e, t = a.settings.powerpaste_word_import || Gr.officeStyles,
	...
	function Jr(u, e, t, r, c) {
		...
		u.on("drop", function(e) {
			if (!s) {
				...
				var n = (a = (i = e)
					.target.files || i.dataTransfer.files, $(a, function(e) {
				...
				d(o = r) || !f(o, "text/html") && !f(o, "text/plain") || (Zr(u, ln.translate, c)
					.showDialog(r["text/html"] || r["text/plain"]), e.preventDefault())
			}
			var o, i, a
		})
	}
	var Qr = function() {
		...
		no = function(o, i) {
			...
			return to("required", o), to("optional", i), n = eo(a), X(n, function(e, t) {
				...
				function(t) {
					...
					Q(o, function(e) {
						...
						throw new Error("All required keys (" + eo(e)
							.join(", ") + ") were not specified. Specified keys were: " + eo(t)
							.join(", ") + ".")
					}(o, n);
					var e = $(n, function(e) {
						return !Y(a, e)
					...
					0 < e.length && function(e) {
						throw new Error("Unsupported keys for object: " + eo(e)
							.join(", "))
					}(e);
					var r = {};
	...
	var ao = {
		...
		wo = function(e, t) {
			var n = void 0 === t ? y.document : t.dom();
			return To(n) ? _.none() : _.from(n.querySelector(e))
				.map(cn.fromDom)
		},
		Io = function(e, t) {
			return e.dom() === t.dom()
		...
		So = (At.detect()
			.browser.isIE(), xo),
		Lo = function(e) {
			return cn.fromDom(e.dom()
				.ownerDocument)
		},
		Co = function(e) {
			var t = e.dom();
			return _.from(t.parentNode)
				.map(cn.fromDom)
		},
		No = function(e, t) {
		...
		Do = function(e) {
			var t = e.dom();
			return _.from(t.previousSibling)
				.map(cn.fromDom)
		},
		Oo = function(e) {
			var t = e.dom();
			return _.from(t.nextSibling)
				.map(cn.fromDom)
		},
		Ao = function(e) {
			return t = ho(e, Do), (n = ee.call(t, 0))
				.reverse(), n;
			var t, n
		},
		_o = function(e) {
		...
		Mo = (Qr("element", "offset"), function(e, t) {
			var n = [];
	...
	function Bo() {
		...
		return {
			...
			report: function(e, t, r) {
				...
				q(t, function(e) {
					var t, n;
					Kt(e, Fo), t = r, n = e, i.push({
						success: t,
						element: n.dom()
					})
				}), n = e, o = $(o, function(e, t) {
					return e !== n
				}), !1 === u() && a()
			},
			inProgress: u,
	...
	var Yo = ue([{
		...
		qo = function(n, e) {
			...
			var t = e.accept();
			n.setRequestHeader("Accept", t), e.credentials()
				.each(function(e) {
					n.withCredentials = e
				}), e.responseType()
				.each(function(e) {
		...
		ei = {
			handle: function(n, e, r) {
				...
				return e.match({
						json: function() {
							return Zo(r.response)
								.fold(t, Xe.pure)
						},
						blob: function() {
							return e = r, _.from(e.response)
								.map($o)
								.getOr(Xe.pure("no response content"));
							var e
						},
						text: t,
						html: t,
		...
		si = function(i, a, u, c, s, e) {
			...
			return ii(function(t) {
					...
					n.onload = function() {
						0 !== n.status || Et(i, "file:") ? n.status < 100 || 400 <= n.status ? o() : ci(c, n)
							.get(t) : o()
		...
		Li = function(e, t) {
			var n = {
				...
				o = Ti(t, n),
				i = {};
			return "" !== o.protocol ? (i.protocol = o.protocol, i.authority = o.authority, i.path = Ii(o.path), i.query = o.query) : ("" !== o.authority ? (i.authority = o.authority, i.path = Ii(o.path), i.query = o.query) : ("" === o.path ? (i.path = r.path, "" !== o.query ? i.query = o.query : i.query = r.query) : (Et(o.path, "/") ? i.path = Ii(o.path) : (i.path = Si(r.path, o.path, e.authority), i.path = Ii(i.path)), i.query = o.query), i.authority = r.authority), i.protocol = r.protocol), i.anchor = o.anchor, i
		},
		Ci = function(e, t) {
			var n = Li(e, t);
			return bi(n)
	...
	function Ni(d) {
		var e, t, n, r, m = (e = d.url, t = e.lastIndexOf("/"), n = 0 < t ? e.substr(0, t) : e, r = void 0 === d.basePath ? n : d.basePath, wt(r, "/") ? r : r + "/"),
			o = function(e, t, l) {
				var n, r, o, i, a, u, f = yi.getFilename(e, t),
					c = !0 === d.credentials ? mi.xhr() : mi.none(),
					s = fi.file(yi.buildData("image", e, f));
				(n = d.url, r = s, o = gi.text(), i = c, u = Ho.post(), si(n, u, _.some(r), o, i, a))
				.map(function(e) {
					e.fold(function(e) {
						...
						var a, u, c, s = (a = f, u = n.split(/\s+/), c = 1 === u.length && "" !== u[0] ? u[0] : a, Ci(m, c));
						l(Go.value({
							location: s
						}))
					})
	...
	var Di = function(e) {
		...
		Pi = function(e, t) {
			return o = t, i = Oi(n = e, r = "class")
				.concat([o]), Vt(n, r, i.join(" ")), !0;
			var n, r, o, i
		},
		ki = function(e, t) {
			return o = t, 0 < (i = $(Oi(n = e, r = "class"), function(e) {
					return e !== o
				}))
				.length ? Vt(n, r, i.join(" ")) : Kt(n, r), !1;
			var n, r, o, i
		},
		Mi = function(e, t) {
			Ai(e) ? e.dom()
				.classList.add(t) : Pi(e, t)
		},
		Ri = function(e, t) {
			var n;
			Ai(e) ? e.dom()
				.classList.remove(t) : ki(e, t), 0 === (Ai(n = e) ? n.dom()
					.classList : _i(n))
				.length && Kt(n, "class")
		},
		Fi = function(e, t) {
		...
		Ui = function(e) {
			return Ai(e) ? function(e) {
				for (var t = e.dom()
					.classList, n = new Array(t.length), r = 0; r < t.length; r++) n[r] = t.item(r);
				return n
			}(e) : _i(e)
		},
		Bi = function(t) {
		...
		Qi = function(e, n, a, r, u, t, c) {
			var s = function() {
				y.console.error("Internal error with blob cache", u), c(zi.failure({
					status: v(666)
				}))
			};
			e.upload(t, u, function(e) {
				var t, i = n.findById(r, u);
				q(i, (t = go.uploadInProgress(), function(e) {
					Ri(e, t)
				})), e.fold(function(e) {
					c(zi.failure(e))
				}, function(t) {
					var e, n, r, o;
					(e = a, n = i, r = u, o = t, q(n, function(e) {
		...
		ta = function(e, o, t) {
			...
			return e.inProgress() ? [] : W(n, function(e) {
				return t = o, r = Gt(n = e, go.blobId()), t.get(r)
					.fold(function() {
						return Go.error(r)
					}, function(e) {
		...
		oa = {
			getTinymceVersion: function() {
				...
				return e = n.split(".")
					.slice(0, 3)
					.join("."), (t = /([0-9]+)\.([0-9]+)\.([0-9]+)(?:(\-.+)?)/.exec(e)) ? ra(na(t[1]), na(t[2]), na(t[3])) : ra(0, 0, 0)
			}
		};

	function ia(c) {
		var s = function(e, t) {
			return v(4 === (o = oa.getTinymceVersion())
				.major() && o.minor() < 6 ? e : e + "." + (n = t.toLowerCase(), (r = {
						"image/jpeg": "jpg",
						"image/jpg": "jpg",
						"image/gif": "gif",
						"image/png": "png"
			...
			importImages: function(e) {
				var t = J(e, function(e) {
					return me.cata(e, function(e, t, n) {
						...
						return [(r = e, o = t, i = u, a = n, Xe.nu(function(t) {
							We.imageResultToOriginalBlob(o)
								.then(function(e) {
	...
	var aa = function(e, t) {
		...
		ga = function(e) {
			for (var t = 0; t < e.undoManager.data.length; t++) {
				...
				q(o, pa), e.undoManager.data[t].content = r.dom()
					.innerHTML
			}
		},
		va = function(e, t, n) {
			for (var r = 0; r < e.undoManager.data.length; r++) e.undoManager.data[r].content = e.undoManager.data[r].content.split(t.objurl())
				.join(n.location)
		},
		ha = {
		...
		ya = function(r, e) {
			var o, t, i, a, u, n, c = oo(),
				s = Bo(),
				l = (o = r, t = e.url, i = ha, a = function() {
			...
			var p = function(o, i) {
				Ji(s, o.blobInfo()
					...
					.each(function(e) {
						var t, n, r;
						t = e, n = o.blobInfo(), r = i, Qi(f, s, c, d(), t, n, function(e) {
							e.fold(function(e) {
								r(e)
							}, m)
						})
			...
			return {
				...
				uploadImages: function(e) {
					var t, n, r, o, i;
					t = l.instance(), n = ta(s, c, d()), q(n, function(e) {
						e.fold(function(e) {
							s.report(e, _.none(), !1)
						}, function(e) {
							p(e, t)
						})
					}), r = e, o = l.instance(), i = ea(c, d(), r), q(i, function(e) {
						e.fold(function(e) {
							console.error(e)
						}, function(e) {
							p(e, o)
	...
	var Ta = function(t, r, e, n) {
			...
			if (!l.get("_mcePaste")) {
				if (o = l.add(f, "div", {
						id: "_mcePaste",
						class: "mcePaste"
					}, '\ufeff<br _mce_bogus="1">'), u = f !== t.getDoc()
					.body ? l.getPos(t.selection.getStart(), f)
					.y : f.scrollTop, l.setStyles(o, {
						position: "absolute",
						left: -1e4,
						top: u,
						width: 1,
						height: 1,
						overflow: "hidden"
					}), tinymce.isIE) return (a = l.doc.body.createTextRange())
					.moveToElementText(o), a.execCommand("Paste"), l.remove(o), "\ufeff" === o.innerHTML ? (t.execCommand("mcePasteWord"), void n.preventDefault()) : (r(c ? o.innerText : o.innerHTML), tinymce.dom.Event.cancel(n));
				var g = function(e) {
					e.preventDefault()
				};
				if (l.bind(t.getDoc(), "mousedown", g), l.bind(t.getDoc(), "keydown", g), tinymce.isGecko && (a = t.selection.getRng(!0))
					.startContainer === a.endContainer && 3 === a.startContainer.nodeType) {
					var v = l.select("p,h1,h2,h3,h4,h5,h6,pre", o);
					1 === v.length && l.remove(v.reverse(), !0)
				}
				i = t.selection.getRng(), o = o.firstChild, (a = t.getDoc()
						.createRange())
					.setStart(o, 0), a.setEnd(o, 1), s.setRng(a), window.setTimeout(function() {
						var n = "",
							e = l.select("div.mcePaste");
						dn.each(e, function(e) {
							var t = e.firstChild;
							t && "DIV" === t.nodeName && t.style.marginTop && t.style.backgroundColor && l.remove(t, 1), dn.each(l.select("div.mcePaste", e), function(e) {
								l.remove(e, 1)
							...
							l.remove(e)
						}), i && s.setRng(i), r(n), l.unbind(t.getDoc(), "mousedown", g), l.unbind(t.getDoc(), "keydown", g)
					}, 0)
			}
		},
		Ea = {
		...
		Ma = {
			choose: function(e, t, n) {
				var r;
				return (r = n, Pa(e, function(t) {
						return t.getAvailable(r)
							.map(function(e) {
		...
		ja = function(e) {
			var t, n = _o(e);
			0 < n.length && (t = e, q(n, function(e) {
				ua(t, e)
			})), Fa(e)
		},
		Ua = function(e) {
			return t = e, n = !1, cn.fromDom(t.dom()
				.cloneNode(n));
			var t, n
		},
		Ba = function(e) {
		...
		Ga = function(e) {
			return Ht(e) ? (t = "v:shape", n = e.dom()
				.nodeValue, r = cn.fromTag("div"), o = n.indexOf("]>"), r.dom()
				.innerHTML = n.substr(o + "]>".length), Wi(r, function(e) {
					return Ut(e) === t
				})) : _.none();
			var t, n, r, o
		},
				...
				return Ga(e)
					.map(function(e) {
						var t = Gt(e, "o:spid"),
							...
							r = cn.fromTag("img");
						return Mi(r, "rtf-data-image"), Vt(r, "data-image-id", n.substr("_x0000_".length)), Vt(r, "data-image-type", "code"), Wa(r, {
							width: qa(e, "width"),
							height: qa(e, "height")
						}), r
					})
		...
		iu = function(e, t, n) {
			...
			ae(t) !== i.length && (r = e, o = t, q(i, function(e) {
				Kt(r, e)
			}), ne(o, function(e, t) {
				Vt(r, t, e)
			}))
		...
		su = function(e, t, n) {
			var r, o, i, a = e.dom()
				.getAttribute("style"),
				u = (o = {}, i = null != (r = a) ? r.split(";") : [], q(i, function(e) {
					var t = e.split(":");
		...
		hu = function(e, t) {
			var r = fe({
				...
				n = Ro(e, "*");
			q(n, function(n) {
				vu(mu, r.styles, n), vu(pu, r.attributes, n), q(r.classes, function(t) {
		...
		wu = function(e, t, n) {
			...
			switch (e.nodeType) {
				case 1:
					t ? r = Tu : (r = xu, Wa(a, n || {})), o = "HTML" !== e.scopeName && e.scopeName && e.tagName && e.tagName.indexOf(":") <= 0 ? (e.scopeName + ":" + e.tagName)
						.toUpperCase() : e.tagName;
					break;
				case 3:
		...
		Nu = function(e, o) {
			...
			return {
				...
				next: function() {
					var e, t, n = a,
						r = c;
					return !c && a.firstChild ? (u.push(a), a = a.firstChild) : c || 1 !== a.nodeType ? a.nextSibling ? (a = a.nextSibling, c = !1) : (a = u.pop(), c = !0) : c = !0, n === Lu.FINISHED || a || (o.body.removeChild(i), a = Lu.FINISHED), t = r, (e = n) === Lu.FINISHED ? e : e ? Lu.token(e, t) : void 0
				}
			}
		},
		Du = function(e, t, n) {
	...
	var Bu = function(e, t) {
		...
		Ku = function(e, n, t, r) {
			...
			return qu.guessFrom(r.emblems(), i)
				.filter(function(e) {
					return !("OL" === e.tag && (!Y(["P"], (t = n)
						.tag()) || /^MsoHeading/.test(Bu(t, "class"))));
					var t
				})
		},
		Zu = function(e, t) {
		...
		Ju = function(d) {
			return function(e, t, n) {
				var r, o, i, a, u = (r = cn.fromDom(n.getNode()), o = parseInt(Gt(r, "data-list-level"), 10), i = Gt(r, "data-list-emblems"), a = JSON.parse(i), Kt(r, "data-list-level"), Kt(r, "data-list-emblems"), {
					level: v(o),
					emblems: v(a)
				});
				u.level(), t.originalToken.set(n);
				var c, s, l, f = (c = n, s = u, Ku((l = t)
						.listType.get(), c, l.emitter, s)
					.each(l.listType.set), zu(s.level(), l.originalToken.get(), l.listType.get()));
	...
	var nc, rc, oc, ic, ac, uc = function(r) {
			return tc("Inside.List.Item", [Qu(function(e, t) {
				return t.type() === Lu.END_ELEMENT_TYPE && e.originalToken.get() && t.tag() === e.originalToken.get()
					.tag()
			}, function(e, t, n) {
				Xu(t, r.outside())
		...
		Tc = function(e, t, n) {
			var r, o, i, a = hc(t),
				u = e.type() && !qu.eqListType(e.type(), n) ? (r = n, o = bc(e), i = yc(o.state(), r, r.type ? {
					"list-style-type": r.type
				} : {}), fc.result(i.state(), o.result()
					.concat(i.result()))) : fc.result(e, []),
				...
				.getOr([]);
			return fc.result(s.state(), u.result()
				.concat(c)
				.concat(l))
		},
		Ec = bc,
		...
		Lc = function(e, c, s, l) {
			return gc(e, s, function(e) {
				return n = c, r = s, o = l, i = (t = e)
					.level() === r - 1 && n.type ? {
						"list-style-type": n.type
					} : {}, a = xc(t, n, i), u = Tc(a.state(), a.state()
						.level() == r ? o : void 0, n), Ic([a, u]);
				var t, n, r, o, i, a, u
			})
		},
		Cc = function(e, t) {
		...
		Nc = {
			openItem: function(e, t, n, r) {
				var o, i, a, u, c, s, l, f, d, m, p, g, v = e.level() > t ? Cc(e, t) : fc.result(e, []),
					h = v.state()
					.level() === t ? (f = v.state(), d = r, m = n, p = 0 < f.level() ? wc(f) : fc.result(f, []), g = Tc(p.state(), m, d), Ic([p, g])) : (o = v.state(), i = r, u = n, c = 1 < (a = t) ? mc(o) : fc.value(o, _.none()), s = c.value()
						.map(function(e) {
							return [N(Lu.createEndElement, e)]
						})
						.getOr([]), c.state()
						.level(), l = Lc(c.state(), i, a, u), fc.result(l.state(), s.concat(l.result())));
				return Ic([v, h])
			},
			closeAllLists: Cc
		},
		...
		_c = {
			...
			closeAllLists: function() {
				return Pc()
					.closeAllLists.apply(void 0, arguments)
			},
			openItem: function() {
				return Pc()
					.openItem.apply(void 0, arguments)
			}
		},
		Pc = function() {
			return {
		...
		Mc = (nc = !1, {
			check: function(e) {
				return nc && e.type() === Lu.TEXT_TYPE ? (e.text(), !0) : e.type() === Lu.START_ELEMENT_TYPE && "STYLE" === e.tag() ? nc = !0 : e.type() === Lu.END_ELEMENT_TYPE && "STYLE" === e.tag() && !(nc = !1)
			}
		}),
		Rc = uc(kc),
		Fc = cc(kc),
		jc = (oc = Ac(rc = Fc), ic = Ac(null), ac = Ac(null), {
			reset: function(e) {
				oc.set(rc), ic.set(null), ac.set(null);
				var n, r, i, a, t = (r = (n = e)
					.document, i = fc.state(0, void 0, [], []), a = function(e) {
		...
		Wc = function(u, e) {
			var t = Hc[u] ? [Hc[u]] : [],
				...
				r = J(Bc, function(e) {
					return e.regex.test(u) ? [fe(e.type, (r = u, o = r.split("."), i = function() {
		...
		zc = At.detect()
		.browser,
		Kc = zc.isIE() || zc.isEdge() ? function(e) {
			try {
				return Gc(e)
			} catch (e) {
				return []
		...
		Jc = function(e, t) {
			...
			n.acceptNode = n;
			var r = y.document.createTreeWalker(e.dom(), we.getOrDie("NodeFilter")
				.SHOW_COMMENT, n, !1);
			return Kc(r)
		},
		Qc = function(e, t, n, r) {
			...
			}(e, t, n), o = Jc(e, _.none()), q(o, Fa), q(r, Fa), Kt(e, "style"), Kt(e, "class")
		},
		es = function(e) {
			return (r = e, Xc.extractLevel(r)
					.bind(function(n) {
						return Xc.extractSymSpan(r)
							.bind(function(t) {
								return Xc.extractEmblem(t, !0)
									.map(function(e) {
										return {
											mutate: function() {
												Qc(r, n, e, [t])
				...
				.orThunk(function() {
					return r = e, Xc.extractLevel(r)
						.bind(function(n) {
							return Xc.extractCommentSpan(r)
								.bind(function(t) {
									return Xc.extractEmblem(t, Xc.isSymbol(t))
										.map(function(e) {
											return {
												mutate: function() {
													Qc(r, n, e, [t])
				...
				.orThunk(function() {
					return "p" !== Ut(r = e) ? _.none() : Xc.extractLevel(r)
						.bind(function(n) {
							return Xc.extractMsoIgnore(r)
								.bind(function(t) {
									return Xc.extractEmblem(t, !1)
										.map(function(e) {
											return {
												mutate: function() {
													Qc(r, n, e, [Co(t)
				...
				.orThunk(function() {
					return "p" !== Ut(r = e) ? _.none() : Xc.extractMsoIgnore(r)
						.bind(function(e) {
							var n = Co(e)
								.getOr(e),
								t = Xc.isSymbol(n);
							return Xc.extractEmblem(e, t)
								.bind(function(t) {
									return Xc.deduceLevel(r)
										.map(function(e) {
											return {
												mutate: function() {
													Qc(r, e, t, [n])
		...
		rs = function(e) {
			return void 0 === e.dom()
				.attributes || null === e.dom()
				.attributes || 0 === e.dom()
				.attributes.length || 1 === e.dom()
				.attributes.length && "style" === e.dom()
				.attributes[0].name
		},
		os = {
			...
			hasContent: function(e) {
				return !rs(e) || (n = (t = e)
					.dom()
					.attributes, r = null != n && 0 < n.length, ("span" !== Ut(t) || r) && ns(e, function(e) {
						var t = !rs(e),
	...
	var as, us, cs, ss, ls, fs, ds, ms = is(qt, "text"),
		ps = function(e) {
			return ms.get(e)
		},
		gs = function(e, t) {
		...
		hs = function(e) {
			return Do(e)
				.bind(function(e) {
					return qt(e) && 0 === ps(e)
						.trim()
						.length ? hs(e) : "li" === Ut(e) ? _.some(e) : _.none()
				})
		},
		ys = {
			changeTag: vs,
		...
		Fs = ku({
			tags: [{
				...
				condition: (as = os.hasContent, function() {
					for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
		...
		js = ku({
			tags: [{
				...
				condition: (us = "li", function(e) {
					return Co(e)
						.exists(function(e) {
							return Ut(e) === us && 1 === _o(e)
								.length
						})
				})
			}]
		...
		qs = {
			...
			inlineTagFixes: Ys,
			cleanupFlags: Hs,
			distillAnchorsFromLocalLinks: (fs = /^file:\/\/\/[^#]+(#[^#]+)$/, Mu({
				tags: [{
					name: tu.exact("a", tu.caseInsensitive),
					condition: function(e) {
						var t = Gt(e, "href");
			...
			removeFragmentComments: function(a) {
				...
				t.each(function(i) {
					n.each(function(e) {
						for (var t, n = i, r = [], o = (t = bs(i, 0, e, 0), cn.fromDom(t.commonAncestorContainer)); void 0 !== o && !Io(o, a);) Y(u, Ut(o)) ? n = o : r.push(o), o = Co(o)
							.getOr(void 0);
						q(r, ja), q(Ao(n), Fa)
					}), Fa(i)
				}), n.each(Fa)
		...
		Vs = function(i, a) {
			return Uu(function(e, t) {
				var r, o, n = (r = t, o = a, i(cn.fromDom(r.getNode()))
					.fold(function() {
						return [r]
					}, function(e) {
		...
		Xs = function(e, t, n) {
			var r, o, i, a, u, c, s, l, f, d, m, p, g, v = (r = e, i = (o = n)
				.browser.isFirefox() || o.browser.isEdge(), a = i ? Ka.local : Ka.vshape, u = !i, c = $s(o) ? qs.none : Ru([Vs(a, u)]), {
					annotate: [r ? c : qs.none],
					local: [i ? qs.none : qs.removeLocalImages]
				});
			return Z([(p = e, g = n, $s(g) || !p ? [] : [ts.preprocess]), v.annotate, [qs.inlineTagFixes], function(e, t, n) {
					if (!e) return [qs.none];
					var r = [qs.unwrapWordTags],
						o = $s(n) ? [] : qs.parseLists;
					return r.concat(o)
						.concat([qs.removeWordAttributes])
				}(e, 0, n), [qs.removeGoogleDocsId],
				[qs.nestedListFixes],
				[qs.removeExcess],
				[qs.removeMetaTags], v.local, (m = t, m ? [qs.mergeStyles, qs.mergeClasses] : [qs.cleanStyles, qs.cleanClasses]), [qs.distillAnchorsFromLocalLinks, qs.removeLocalLinks, qs.removeVacantLinks, qs.replaceClipboardChangedUrls],
				[qs.removeEmptyStyle],
				[qs.removeEmptyClass],
				[qs.pruneInlineTags],
				[qs.cleanupBrowserTags], (f = e, d = t, !f && d ? [qs.cleanupBrowserCruft] : []), [qs.unwrapConvertedSpace],
				[qs.addPlaceholders], (s = e, l = n, $s(l) && s ? [qs.unwrapSingleParagraphsInlists] : []), [qs.cleanupFlags],
				[qs.removeStyleTags]
			])
		},
		Gs = ["body", "p", "div", "article", "aside", "figcaption", "figure", "footer", "header", "nav", "section", "ol", "ul", "li", "table", "thead", "tbody", "tfoot", "caption", "tr", "td", "th", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "pre", "address"],
		zs = function(e) {
			return t = e, n = v(0), r = v(0), o = _.none(), {
				term: function() {
		...
		Zs = function(e, t, n) {
			var r, o, i = n(e, t);
			return r = i, o = e.start(), W(r, function(e) {
				return ti({}, e, {
					start: v(e.start() + o),
					finish: v(e.finish() + o)
				})
		...
		Js = function(e, n, t) {
			return void 0 === t && (t = 0), V(e, function(t, e) {
					return n(e, t.len)
						.fold(v(t), function(e) {
							return {
								len: e.finish(),
		...
		tl = function(n, e) {
			...
			return t = o, (r = Array.prototype.slice.call(t, 0))
				.sort(function(e, t) {
		...
		rl = (Qr("begin", "end"), Qr("element", "text"), ue([{
			include: ["item"]
		}, {
			excludeWith: ["item"]
		}, {
		...
		ml = function(t, e, n) {
			if (t.property()
				.isText(e)) return [dl.text(e, t)];
			if (t.property()
				.isEmptyTag(e)) return [dl.empty(e, t)];
			if (t.property()
				.isElement(e)) {
				var r = t.property()
					.children(e),
					o = t.property()
					.isBoundary(e) ? [dl.boundary(e, t)] : [],
			...
			var n = J(t, function(e) {
				...
				i = Qs(e, n, function(e, t) {
					return function(o, e, t) {
						...
						return o.insert()
							.afterAll(e, a), [nl(e, 0, r[0].length)].concat(i)
					}(o, e.element(), t)
				});
			return W(t, function(e) {
		...
		Tl = /(?:(?:[A-Za-z]{3,9}:(?:\/\/))(?:[-.~*+=!&;:'%@?^${}(),\w]+@)?[A-Za-z0-9-]+(?:\.[A-Za-z0-9-]+)*|(?:www\.|[-;:&=+$,.\w]+@)[A-Za-z0-9-]+(?:\.[A-Za-z0-9-]+)*)(?::[0-9]+)?(?:\/[-+~=%.()\/\w]*)?(?:\?(?:[-.~*+=!&;:'%@?^${}(),\/\w]+))?(?:#(?:[-.~*+=!&;:'%@?^${}(),\/\w]+))?/g.source,
		El = function(e) {
		...
		Sl = {
			links: function(e) {
				...
				q(t, function(e) {
					var n, t = e.exact();
					(t.indexOf("@") < 0 || Il(t)) && (n = e.elements(), _.from(n[0])
						.filter(wl)
						.map(function(e) {
							var t = cn.fromTag("a");
		...
		_l = function(e) {
			...
			return ne(e, function(r, o) {
				t[o] = function(e) {
					return {
						_simpleAdt: i(o),
						data: (t = r, n = e, 0 === t.length ? {} : no(t, [])(n)),
						_simpleAdt_data: e
					};
					var t, n
				}
				...
				match: function(t, n) {
					...
					return Pa(r, function(e) {
						...
						.getOrDie("Must find branch for constructor: " + (0 === (e = t._simpleAdt)
							.indexOf(Al) ? e.substring(Al.length + "_".length) : e))(t.data)
				}
			})
		},
		Pl = _l({
		...
		Xl = function(e) {
			return Ul ? _.some(e.clipboardData)
				.filter(Rl.isValidData) : _.none()
		},
		Gl = function(e) {
			...
			var n = Ol(Lo(t), t),
				r = cn.fromTag("div");
			return _u(r, n), Fl.constructors.html({
				container: r
			})
		},
		zl = {
			fromEvent: function(e) {
				var t = function(t) {
						return void 0 === t.items ? _.none() : Rl.getPreferredFlavor(Bl, t.types)
							.map(function(e) {
					...
					r = function(t) {
						return Pa(t.types, function(e) {
							return "text/plain" === e ? _.some(t.getData(e))
								.map(function(e) {
		...
		rf = nf ? function(e, t, n) {
			t.control.block(), e.dom()
				.execCommand("paste"), n(), t.control.unblock()
		} : function(e, t, n) {
			setTimeout(n, 1)
		},
		of = {
				...
				.match({
					...
					rtl: function(t, n, r, o) {
						...
						if (s.setBaseAndExtent) s.setBaseAndExtent(t.dom(), n, r.dom(), o);
							...
							i = t, a = n, u = r, c = o, (e = s)
								.collapse(i.dom(), a), e.extend(u.dom(), c)
						} catch (e) {
							hf(l, r, o, t, n)
						} else hf(l, r, o, t, n)
					}
		...
		bf = function(e) {
			var t, n, r, o, i, a, u = cn.fromDom(e.anchorNode),
				c = cn.fromDom(e.focusNode);
			return t = u, n = e.anchorOffset, r = c, o = e.focusOffset, i = bs(t, n, r, o), a = Io(t, r) && n === o, i.collapsed && !a ? _.some(sf(u, e.anchorOffset, c, e.focusOffset)) : function(e) {
				if (0 < e.rangeCount) {
	...
	function Ef(i, a) {
		var u = ao.create({
			...
			o = Jl.tap(function(n) {
				xf(n.target.ownerDocument.defaultView)
					.each(function(e) {
						if (!Fi(e.start(), ef.bin())) {
							var t = zl.fromEvent(n); of .willBlock() && (o.control.block(), n.preventDefault()), r(t, o.control, function() {
								n.preventDefault()
							})
						}
					})
	...
	var wf = Qr("asset", "image"),
		...
		Lf = function(o) {
			...
			return me.cata(o.asset(), function(e, t, n) {
				return /tiff$/.test(t.getType()) ? (r = t, Xe.nu(function(t) {
						var e = We.imageResultToBlob(r, "image/png")
							.then(function(e) {
								an.single(e)
									.map(_.some)
									.get(t)
	...
	var Nf = function(r) {
		...
		Of = function(n) {
			var e, t = Te("window.clipboardData.files"),
				r = void 0 !== (e = n)
				.convertURL ? e.convertURL : void 0 !== e.msConvertURL ? e.msConvertURL : void 0;
		...
		Rf = function(e) {
			return J(_f(e), function(e) {
				...
				return Pf(i) ? (r = e, o = i, Me(o)
						.map(function(e) {
							return Sf.assetImage(an.single(e), r)
						}))
					.toArray() : kf(i) ? (n = e, t = i, Re(t)
						.map(function(e) {
			...
			return _a.sync(function(u) {
				var c = function() {
					...
					s = function(e) {
						var t, n, r = $(_f(e), Mf);
						q(r, Fa), _a.call(u, {
							response: 0 < r.length ? (t = e, n = $(t, function(e) {
					...
					e = function(e, t, n) {
						var r, o, i, a;
						!1 === f.allowLocalImages ? s(e) : 0 === t.length ? (o = Rf(r = e), i = Ke(o, function(e) {
							return e.asset()
						}), a = W(o, function(e) {
							return e.image()
						}), i.get(function(e) {
	...
	var jf = function(e, t) {
		...
		Jf = function(e) {
			for (var a = [], t = function() {
				...
				var t, r, o, i, n = (r = (t = e)
					.bower, o = t.regex, i = t.isEquation, Zf(r)
					.map(function(e) {
						var n = t.idRef + e;
						return zf(r)
							.fold(function(e) {
				...
				var i = V(t, function(t, n) {
						...
						return G(t, function(e) {
							...
							.fold(function() {
								...
								return ed.toBlob(t[e])
									.isValue() ? t : t.slice(0, e)
									.concat(t.slice(e + 1))
									.concat([n])
							})
					}, []),
					...
					r = J(e, function(t, e) {
						...
						return Kt(t, "rtf-data-image"), Kt(t, "data-image-id"), Kt(t, "data-ms-equation"), "unsupported" === n ? (u = !0, Vt(t, "alt", o("errors.imageimport.unsupported")), []) : X(i, function(e) {
	...
	function id(e, t) {
		var i, a, u, c, s = (i = e, a = t, u = ao.create({
					insert: io(["elements", "correlated"]),
					incomplete: io(["elements", "correlated", "message"])
				}), (c = od(a))
				.events.incomplete.bind(function(e) {
					...
					gordon: function(n, r) {
						...
						if (!0 === a.allowLocalImages && !0 === a.enableFlashImport) {
							...
							}), o.events.failed.bind(e), o.events.error.bind(e), o.open()
			...
			proxyBin: function(n) {
				return {
					handle: function(e, t) {
						return n.proxyBin()
							.fold(function() {
								return y.console.error(e), _a.pure({
									response: Na.cancel(),
									bundle: Sa.nu({})
								})
							}, t)
			...
			get: function(e, t) {
				...
				"clean" === n ? f(!1, r, t) : "merge" === n ? f(!0, r, t) : function(e, t) {
					...
					var i = {
						...
						c = s(!0);
					c.setTitle(l("cement.dialog.paste.title")), c.setContent(n), c.setButtons([i, a]), c.events.close.bind(function() {
						t(_.none()), u()
					}), c.show()
				}(r, t)
			},
	...
	var dd, md, pd, gd = function(e, t) {
		...
		yd = function(m, p) {
			return function(e) {
				if (m(e)) {
					var t, n, r, o, i, a, u, c = cn.fromDom(e.target),
						s = function() {
							e.stopPropagation()
						},
						l = function() {
						...
						f = g(l, s),
						d = (t = c, n = e.clientX, r = e.clientY, o = s, i = l, a = f, u = e, {
							target: v(t),
							x: v(n),
							y: v(r),
							stop: o,
		...
		bd = function(e, t, n, r) {
			return o = e, i = t, a = !1, u = yd(n, r), o.dom()
				.addEventListener(i, u, a), {
					unbind: N(xd, o, i, u, a)
				};
			var o, i, a, u
		},
	...
	md = Dd, pd = Od, dd = void 0,
		function(e) {
			"object" == typeof md && void 0 !== pd ? pd.exports = e() : "function" == typeof dd && dd.amd ? dd([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this)
				...
				1: [function(e, t, n) {
					var r, a, o = (r = function(e) {
						...
						return e = function(e, t) {
								var n, r, o, i, a, u;
								if (e.test(s))
									for (r = 0, o = (n = s.match(e))
										.length; r < o; r += 1) l[t] += 1, i = n[r], a = s.indexOf(i), u = i.length, f.push({
										selector: c.substr(a, u),
										type: t,
										index: a,
										length: u
									}), s = s.replace(i, Array(u + 1)
										.join(" "))
							}, (t = function(e) {
								var t, n, r, o;
								if (e.test(s))
									for (n = 0, r = (t = s.match(e))
										.length; n < r; n += 1) o = t[n], s = s.replace(o, Array(o.length + 1)
										.join("A"))
							})(/\\[0-9A-Fa-f]{6}\s?/g), t(/\\[0-9A-Fa-f]{1,5}\s/g), t(/\\./g), (n = /:not\(([^\)]*)\)/g)
							.test(s) && (s = s.replace(n, "     $1 ")),
							function() {
								var e, t, n, r, o = /{[^]*/gm;
								if (o.test(s))
									for (t = 0, n = (e = s.match(o))
										.length; t < n; t += 1) r = e[t], s = s.replace(r, Array(r.length + 1)
										.join(" "))
							}(), e(/(\[[^\]]+\])/g, "b"), e(/(#[^\#\s\+>~\.\[:]+)/g, "a"), e(/(\.[^\s\+>~\.\[:]+)/g, "b"), e(/(::[^\s\+>~\.\[:]+|:first-line|:first-letter|:before|:after)/gi, "c"), e(/(:[\w-]+\([^\)]*\))/gi, "b"), e(/(:[^\s\+>~\.\[:]+)/g, "b"), s = (s = s.replace(/[\*\s\+>~]/g, " "))
							.replace(/[#\.]/g, " "), e(/([^\s\+>~\.\[:]+)/g, "c"), f.sort(function(e, t) {
	...
	var Ad = Od.exports.boltExport,
		...
		Pd = function(t, e) {
			var n = J(e, function(i) {
				...
				return q(e, function(e) {
					var n, r, o, t = (n = i.raw(), r = e, o = {}, q(n, function(e) {
						if (void 0 !== n[e]) {
							var t = r.dom()
								.style;
							Y(t, e) || (o[e] = n[e])
		...
		Bd = function(l, e) {
			var f = function(n) {
					Kt(n, "data-list-level"), Kt(n, "data-text-indent-alt"), Kt(n, "data-border-margin"), Xa(n, "margin-left"), Xa(n, "text-indent"), ne(function(e) {
						var t = {},
							n = e.dom();
						if (Ba(n))
			...
			if (q(t, function(e) {
				...
				var n = Ro(l, "li");
				q(n, function(e) {
					var t, n, r, o, i, a, u = (t = l, n = cn.fromTag("span"), sa(t, n), r = n, {
		...
		Yd = function(f, d, m) {
			...
			return Va(f, "text-indent")
				.bind(function(l) {
					return Va(f, "margin-left")
						.map(function(e) {
							var t = Va(f, "list-style")
								.exists(function(e) {
									return xt(e, "none")
								}),
				...
				t.cleanDocument(n, c)
					.get(function(e) {
						e.fold(function(e) {
							...
							var t, n, a, u, r, o;
							null == (o = e) || 0 === o.length ? (r = i, _a.call(r, {
								response: Na.paste([], []),
								bundle: Sa.nu({})
							})) : (t = i, n = e, a = s, u = function(e) {
								_a.call(t, {
									response: e,
									bundle: Sa.nu({})
								})
		...
		Qd = function(e, t, n) {
			var r = t.findClipboardTags(_o(n))
				.getOr([]);
			q(r, Fa);
		...
		rm = function(e) {
			var a = Fl.asText(e)
				.getOrDie("Required text input for Text Handler");
			return _a.sync(function(e) {
				var t, n, r, o, i = 0 < a.text()
					.length ? (t = a.text(), n = tm(t), r = nm(n), o = aa(r), Na.paste(o, [])) : Na.cancel();
				_a.call(e, {
					response: i,
					bundle: Sa.nu({})
				})
		...
		um = function() {
			return function(e, t) {
				var n = Fl.asImages(e)
					.getOrDie("Must have image data for images handler");
				return $d(n.images())
			}
		},
		cm = function(i) {
			return function(e, t) {
				var n = Fl.asHtml(e)
					.getOrDie("Wrong input type for HTML handler"),
		...
		lm = function(u, c) {
			return function(e, t) {
				var a = t.bundle();
				return sd.proxyBin(a)
					.handle("There was no proxy bin setup. Ensure you have run proxyStep first.", function(e) {
						var t = sd.merging(a),
							n = sd.isWord(a),
							r = sd.isInternal(a),
		...
		fm = function(o, i) {
			return function(e, t) {
				var n = Fl.asWord(e)
					.getOrDie("Wrong input type for Word Import handler"),
		...
		vm = function(e, t) {
			return ns(e, function(e) {
				return !!zt(e, "style") && -1 < Gt(e, "style")
					.indexOf("mso-")
			})
		},
		hm = function(e, t) {
	...
	function xm(r, l, o, f, i) {
		return function(e, t) {
			var n = Fl.asEvent(e)
				.getOrDie("Must pass through event type")
				.nativeEvent(),
				c = i(),
				s = t.response();
			return _a.sync(function(u) {
				...
				e.events.after.bind(function(e) {
					var t = e.container();
					if (bm.browser.isSafari() && Vi(t, 'img[src^="webkit-fake-url"]')
						.isSome()) {
	...
	var Tm = function(e, t) {
		...
		Dm = {
			wordimport: function(e, t, n, r) {
				return Nm("Word Import pasting", N(Tm, e), [Df(dm({
					isWord: !0
				})), Df(vd(t, n)), Df(fm(e, n.allowLocalImages)), Nf((o = n, i = id(r, n), a = od(o), u = Ac(_.none()), c = function(t) {
					u.get()
						.each(function(e) {
							_a.call(e, {
								response: t,
					...
					var e = Fl.asWord(t)
						.getOrDie("Word input required for rtf data"),
						n = function(o) {
		...
		Om = function(u) {
			...
			var t = function(e, t) {
					var n, r, o, i = c(),
						a = (r = void 0 === (n = i)
							.count ? 0 : n.count, o = "callback_" + r, n.count = r + 1, o);
	...
	function Pm(n, r, o) {
		var e = !0,
			t = y.setInterval(function() {
				var t, e = n.dom();
				j(e.PercentLoaded) && 100 === e.PercentLoaded() && (t = e, Q(r, function(e) {
					return j(t[e])
				})) && (i(), o())
			}, 500),
			i = function() {
	...
	var km = Om("ephox.flash"),
		...
		qm = function(e, t, n, r) {
			...
			}), t.events.reset.bind(a), t.events.hide.bind(function() {
				Wa(i, {
					height: "0",
					padding: "0"
				})
		...
		return {
			open: function() {
				var e = function(r) {
					...
					la(n, l);
					var m = function() {
							Mm.browser.isFirefox() && y.window.getSelection()
								.removeAllRanges(), Am(l)
						},
						p = null,
						g = function() {
						...
						h = function() {
							Ha(n, "display", "none"), Rm.each(function(e) {
								q(e, function(e) {
									e.unbind()
								})
							})
				...
				e.events.cancel.bind(o), e.events.response.bind(function(e) {
	...
	var Xm, Gm, zm = Om("ephox.henchman.features"),
		Km = function(i) {
			return $e.nu(function(t) {
				var e = function() {
					...
					n = cn.fromTag("script");
				Vt(n, "src", i), Vt(n, "type", "text/javascript"), Vt(n, "async", "async"), Vt(n, "data-main", zm.ephemeral(function(e) {
					t(Go.value(e))
				}));
		...
		Zm = function(e, t) {
			var n, r, o, i = t || cn.fromDom(y.document),
				a = cn.fromTag("link", i.dom());
			return Xt(a, {
				rel: "stylesheet",
				type: "text/css",
				href: e
			}), n = i, r = a, o = cn.fromDom(n.dom()
				.head), la(o, r), a
		},
		Jm = function(o, i) {
			return $e.nu(function(t) {
	...
	var ap, up, cp = ["b", "i", "u", "sub", "sup", "strike"],
		sp = function(e) {
			q(_o(e), function(e) {
				var t;
				Wt(t = e) && !t.dom()
					.hasChildNodes() && Y(cp, Ut(t)) && Fa(e)
			})
		},
		lp = function(e, o) {
			var t = _o(e);
			q(t, function(e) {
				var t, n, r;
				o(e) && (n = _o(t = e), r = cn.fromTag("div", Lo(t)
					.dom()), ma(r, n), ua(t, r), Fa(t))
			})
		},
		fp = {
		...
		mp = ef.bin(),
		pp = mp + Je(""),
		gp = (ap = "-100000px", up = "100000px", function(e) {
	...
	function bp(a) {
		return function(t) {
			var u, r, o, c, n = ao.create({
				...
				i = (u = yp, r = cn.fromTag("br"), o = _.none(), c = function(e) {
					return Lo(e)
						.dom()
						.defaultView
				}, {
	...
	var xp = "powerpaste-styles",
		...
		Ep = {
			injectStyles: function(e) {
				if (!xl(Tp)) {
					...
					var r = qi("head")
						.getOrDie("Head element could not be found.");
					la(r, n)
				}
			},
			removeStyles: function() {
				if (xl(Tp)) {
					var e = qi("head")
						.getOrDie("Head element could not be found."),
						t = Vi(e, Tp)
						.getOrDie("The style element could not be removed");
					Fa(t)
				}
			}
		},
		...
		Hp = {
			...
			linkSelection: function(r, e) {
				return Up(e)
					.bind(function(e) {
						var t, n;
						return !1 === r.selection.isCollapsed() && Fp(e.url()) ? Bp(t = r, (n = e)
							.html(),
							function() {
		...
		$p = {
			process: function(e, t, n) {
				...
				return d = v, m = n, o = Wp(f = r = e, "PastePreProcess") ? (p = d, g = m, f.fire("PastePreProcess", {
						internal: g,
						content: p
					})
					.content) : d, i = n, Wp(r, "PastePostProcess") ? (u = o, c = i, s = (a = r)
					.dom.add(a.getBody(), "div", {
						style: "display:none"
					}, u), l = a.fire("PastePostProcess", {
						internal: c,
						node: s
					})
					.node.innerHTML, a.dom.remove(s), l) : o
			},
	...
	function Vp(v, h, e, t, y, b) {
		...
		var S = function(e, t, n) {
				...
				Hp.until(e, t, o.concat([(r = n, function(e, t) {
		...
		v.on("init", function(e) {
			...
			var s, a, t, n, r, o, i, u, c, l = {
				...
				m = (t = d, n = f.createDialog, r = C, i = op((o = l)
					.baseUrl), u = N($m, n), c = bp(void 0 !== o.pasteBinAttrs ? o.pasteBinAttrs : {}), Ef([Dm.onlyText(), Dm.wordimport(i, n, o, u), Dm.googledocs(o, r, t), Dm.nativeHtml(n, o, r, t), Dm.image(o)], Dm.fallback(n, o, r, c, t, u))),
				p = Ef([Dm.text()], Dm.none());
			q([m, p], function(e) {
				e.events.cancel.bind(function() {
					L()
				}), e.events.error.bind(function(e) {
					L(), v.notificationManager ? v.notificationManager.open({
							text: ln.translate(e.message()),
							type: "error"
						}) : (b ? Pp : ha)
						.showDialog(v, ln.translate(e.message()))
					...
					v.focus(), y.importImages(e.assets())
						.get(function() {
			...
			var g = Ed(d, "paste", function(e) {
				x || (x = v.selection.getBookmark(1)), (h.isText() ? p : m)
					.paste(e.raw()), h.reset()
			});
			I.set(_.some(g)), Ap.register(v)
		}), v.on("remove", function(e) {
			1 === tinymce.editors.length && Ep.removeStyles(), I.get()
				.each(function(e) {
					return e.unbind()
				})
		})
	...
	function Gp(u) {
		return c(tinymce, "4.0.28") ? (t.error('The "powerpaste" plugin requires at least 4.0.28 version of TinyMCE.'), function() {}) : function(n, e) {
			...
			tinymce.Env.ie && tinymce.Env.ie < 10 ? function(t, e, n) {
				...
				r = Ea.getOnPasteFunction(t, a.showDialog, e), t.on("paste", u(r)), o = Ea.getOnKeyDownFunction(t, a.showDialog, e), t.on("keydown", u(o)), t.addCommand("mceInsertClipboardContent", function(e, t) {
			...
			}(n, o) : (t = xa(n), Vp(n, o, e, u, t, r), l(n) ? d(n) : Jr(n, 0, 0, t, r)), $p.registerEvents(n), r ? (n.ui.registry.addToggleButton("pastetext", {
				icon: "paste-text",
	...
	return function(e) {
		tinymce.PluginManager.requireLangPack("powerpaste", "ar,ca,cs,da,de,el,es,fa,fi,fr_FR,he_IL,hr,hu_HU,it,ja,kk,ko_KR,nb_NO,nl,pl,pt_BR,pt_PT,ro,ru,sk,sl_SI,sv_SE,th_TH,tr,uk,zh_CN,zh_TW"), tinymce.PluginManager.add("powerpaste", Gp(e))
	}
}(window)();