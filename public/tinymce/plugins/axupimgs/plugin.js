/*
 * @Author: Blueth007
 * @Date: 2022-03-16 15:59:34
 * @LastEditTime: 2022-08-08 15:59:44
 * @Description
 * MIT
 */
...
tinymce.PluginManager.add("axupimgs", function (editor, url) {
  ...
  var baseURL = tinymce.documentBaseURL;
  var iframe1 = baseURL + url + "/upfiles.html";
  // console.log(tinymce, iframe1);
