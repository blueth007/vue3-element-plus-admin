/*
 * @Author: Blueth007
 * @Date: 2022-03-16 15:55:38
 * @LastEditTime: 2022-08-08 17:04:47
 * @Description:
 * MIT
 */
tinymce.PluginManager.add("bdmap", function (editor, url) {
  var pluginName = "插入百度地图";
  var baseURL = tinymce.documentBaseURL + url;
  var iframe1 = baseURL + "/map.html";
        ...
        switch (details.name) {
          case "save":
            html =
              ...
              tinymceLat +
              "&zoom=14&width=" +
              (bdmap_width(editor) - 2) +
              "&height=" +
              (bdmap_height(editor) - 2) +
  ...
  editor.ui.registry.getAll().icons.bdmap ||
