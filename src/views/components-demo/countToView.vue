<template>
    <div class="components-container">
        ...
        <vue-count-to ref="example" :start-val="_startVal" :end-val="_endVal" :duration="_duration" :decimals="_decimals"
            :separator="_separator" :prefix="_prefix" :suffix="_suffix" :autoplay="false" class="example" />
        ...
        <aside>&lt;count-to :start-val=&#x27;{{ _startVal }}&#x27; :end-val=&#x27;{{ _endVal }}&#x27; :duration=&#x27;{{
            _duration }}&#x27;
...
const { setStartVal,
    ...
    setSeparator,
    setPrefix,
    setSuffix } = toRefs(data)

const _startVal = computed(() => {
    if (data.setStartVal) {
        return data.setStartVal
    } else {
        return 0
    }
})

const _endVal = computed(() => {
    if (data.setEndVal) {
        return data.setEndVal
    } else {
        return 0
    }
})
...
const _separator = computed(() => {
    return data.setSeparator
})

const _suffix = computed(() => {
    return data.setSuffix
})

const _prefix = computed(() => {
    return data.setPrefix
})
