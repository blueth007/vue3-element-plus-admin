<template>
    <div class="app-container">
        <div style="margin-bottm:20px;">
            ...
            <el-button :loading="downloadLoading" style="margin: 0 20px ;" type="primary" @click="handleDownload">
...
const { list, filename, autoWidth, bookType, downloadLoading, listLoading } = toRefs(data)
onBeforeMount(() => {
    fetchData()
})
function fetchData() {
